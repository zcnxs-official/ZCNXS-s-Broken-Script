...
Announce_Label.Text = loadstring(game:HttpGet("https://raw.githubusercontent.com/zcnxs-official/ZCNXS-s-Broken-Script/refs/heads/main/Home-text.txt"))()
...
local totalSize = 9999
local tileSize = 1024 -- each part size (within Roblox's safe range)
local height = 16
local workspaceCenter = Vector3.new(66, -8, 72.5) -- your target center position

-- Calculate how many tiles are needed along X and Z
local tilesX = math.ceil(totalSize / tileSize)
local tilesZ = math.ceil(totalSize / tileSize)

-- Get starting point to center the grid at workspaceCenter
local startX = workspaceCenter.X - ((tilesX * tileSize) / 2) + (tileSize / 2)
local startZ = workspaceCenter.Z - ((tilesZ * tileSize) / 2) + (tileSize / 2)
